...
#define MQTT_TOPIC              "espgps"            //The MQTT topic base. Messages are published to MQTT_TOPIC/MQTT_CLIENT_ID/data, and the module will subscribe to MQTT_TOPIC/MQTT_CLIENT_ID/api

#define BATTERY_CRIT_SLEEP      60 * 60 * 1000      //Time in milliseconds to sleep when the battery is critically low.
...
#define BATTERY_OK_INTERVAL     10 * 60 * 1000      //How often (in milliseconds) to publish data to the MQTT broker when the battery is above the low threshold.
